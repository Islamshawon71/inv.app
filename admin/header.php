                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="new-order.php">New Order</a>
                    ...
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item">
                                    <a href="orders.php?orders=All" class="sidebar-link">
                                        <i class="mdi mdi-note-outline"></i>
                                        <span class="hide-menu"> All Orders </span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="orders.php?orders=Processing" class="sidebar-link">
                                        <i class="mdi mdi-note-outline"></i>
                                        <span class="hide-menu"> Processing </span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="orders.php?orders=Pending Payment" class="sidebar-link">
                                        <i class="mdi mdi-note-plus"></i>
                                        <span class="hide-menu"> Pending Payment </span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="orders.php?orders=On Hold" class="sidebar-link">
                                        <i class="mdi mdi-note-plus"></i>
                                        <span class="hide-menu"> On Hold </span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="orders.php?orders=Cancel" class="sidebar-link">
                                        <i class="mdi mdi-delete"></i>
                                        <span class="hide-menu"> Cancel </span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="orders.php?orders=Completed" class="sidebar-link">
                                        <i class="mdi mdi-note-plus"></i>
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item">
                                    <a href="invoice-order.php?orders=Pending Invoice" class="sidebar-link">
                                        <i class="mdi mdi-note-outline"></i>
                                        <span class="hide-menu"> Pending Invoice</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="invoice-order.php?orders=Stock Out" class="sidebar-link">
                                        <i class="mdi mdi-note-outline"></i>
                                        <span class="hide-menu"> Stock Out</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="invoice-order.php?orders=Invoiced" class="sidebar-link">
                                        <i class="mdi mdi-note-outline"></i>
                                        <span class="hide-menu">Invoiced</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item">
                                    <a href="final.php?orders=Delivered" class="sidebar-link">
                                        <i class="mdi mdi-note-outline"></i>
                                        <span class="hide-menu"> Delivered</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="final.php?orders=Confirmed By Customer" class="sidebar-link">
                                        <i class="mdi mdi-note-outline"></i>
                                        <span class="hide-menu">Confirmed By Customer</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="final.php?orders=Paid" class="sidebar-link">
                                        <i class="mdi mdi-note-outline"></i>
                                        <span class="hide-menu">Paid</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="final.php?orders=Return" class="sidebar-link">
                                        <i class="mdi mdi-note-outline"></i>
                                        <span class="hide-menu">Return</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="final.php?orders=Courier Lost" class="sidebar-link">
                                        <i class="mdi mdi-note-outline"></i>
                                        <span class="hide-menu">Courier Lost</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                                <i class="mdi mdi-receipt"></i>
                                <span class="hide-menu">Courier </span>
                            </a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item">
                                ...
                                <li class="sidebar-item">
                                    <a href="city.php" class="sidebar-link">
                                        <i class="mdi mdi-note-outline"></i>
                                        <span class="hide-menu">City</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="zone.php" class="sidebar-link">
                                        <i class="mdi mdi-note-outline"></i>
                        ...
                        -->
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="payment.php" aria-expanded="false">
