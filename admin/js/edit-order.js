$(document).ready(function () {
  ...
  $("#placeOrder").click(function () {
    ...
    var PaidReturnDate = $("#PaidReturnDate").val();
    ...
    if (CustomerName == "") {
      ...
      data["PaidReturnDate"] = PaidReturnDate;
  ...
  $("#oldOrder").DataTable({
    ajax: "ajax/edit-order.php?action=oldOrders" + "&&orderID=" + $("#orderID").val() + "&&CustomerPhone=" + $("#CustomerPhone").val(),
    columns: [
      { data: "invoiceID" },
      {
        data: null,
